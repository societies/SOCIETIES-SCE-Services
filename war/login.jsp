...
<head>
	...
	<link rel="stylesheet" href="/css/jquery.mobile-1.4.0-rc.1.min.css" type="text/css" media="screen"/>
	<script src="/js/jquery-2.0.0.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="/js/jquery.mobile-1.4.0-rc.1.min.js" type="text/javascript" charset="utf-8"></script>
