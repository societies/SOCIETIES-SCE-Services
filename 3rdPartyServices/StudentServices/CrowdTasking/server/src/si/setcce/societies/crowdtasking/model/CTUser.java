...
import si.setcce.societies.crowdtasking.api.RESTful.impl.TagAPI;
...
/**        interestsKeys = new ArrayList<Key<Tag>>();
 ...
 interestsKeys.add(new Key<Tag>(Tag.class, tag.getId()));
    ...
    public void setTrustRelationships(String trustRelationshipsJSON) {
        Gson gson = new Gson();
        List<TrustRelationship> trustRelationships = gson.fromJson(trustRelationshipsJSON, new TypeToken<List<TrustRelationship>>() {
        }.getType());
