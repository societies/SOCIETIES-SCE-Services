...
<link rel='stylesheet' type='text/css' href='/sharedCal/resources/css/timepicker.css' />
...
<script type="text/javascript" src="/sharedCal/resources/js/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript" src="/sharedCal/resources/js/jquery-ui-sliderAccess.js"></script>
...
<div id="divHeader">
	...
	<div>
		...
		Start Date: <input id="evt_start" class="hasDatepicker" type="text" value="" name="evt_start"><br/>
		End Date: <input id="evt_end" class="hasDatepicker" type="text" value="" name="evt_end"><br/>
		...
		<button id="add_CIS_Evt">Add Event To CIS Calendar</button><br/>
		<button id="add_CSS_Evt">Add Event To CSS Calendar</button><br/>
	</div>
