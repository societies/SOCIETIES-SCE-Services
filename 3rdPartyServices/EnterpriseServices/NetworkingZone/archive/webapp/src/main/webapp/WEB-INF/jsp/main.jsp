		...
		<ul >
			...
			<li id="li_password" >
				<div>
					...
					<input id="element_password1" name="element_password1" class="element text medium" type="password" maxlength="255" value="" onChange="doAjaxCheckMatchingPassword()"/> 
				</div>
				<div> 
				...
				<table>
						...
						<tr>
							<td width=50%>
								...
								<input id="element_company" name="element_company" class="element text medium" type="text" maxlength="255" value=""/>
							</td>
							<td> 
				...
				<table>		
						<tr>
							<td width=50%>
								...
								<input id="element_department" name="element_department" class="element text medium" type="text" maxlength="255" value=""/>
							</td>
							<td>  
